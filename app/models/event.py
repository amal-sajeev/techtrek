...
class Event(Base):
    ...
    cert_template_id = Column(Integer, ForeignKey("certificate_templates.id"), nullable=True)
    ...
    cert_template = relationship("CertificateTemplate", back_populates="events", foreign_keys=[cert_template_id])
